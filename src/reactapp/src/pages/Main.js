...
export default function EvaluationTable() {
    ...
    return (
            <Stack spacing={8} >
                <Stack align={'center'}>
                    <Heading mt="24px" fontSize={'5xl'}>Evaluations</Heading>
                </Stack>
                    <TableContainer style={{ maxWidth: '100%', overflowY: 'scroll' }} >
                        ...
                        <Thead>
                            <Tr>
                                ...
                                <Th bg="blue.500" color="white">Date</Th>
                                <Th bg="blue.500" color="white">Status</Th>
                            </Tr>
                        </Thead>
                        <Tbody>
                            {data.map((row, i) => (
