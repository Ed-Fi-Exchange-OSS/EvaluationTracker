...
{
    // Use this attribute to mark a DTO / model property as optional in Swagger
}
...
public class SwaggerOptionalSchemaFilter : ISchemaFilter
{
    public void Apply(OpenApiSchema schema, SchemaFilterContext context)
    {
        ...
        foreach (var property in properties)
        {
            ...
            if (attribute != null)
            {
                _ = (schema.Required?.Remove(propertyNameInCamelCasing));
            }
            else
            {
                ...
                {
                    _ = schema.Required.Add(propertyNameInCamelCasing);
                }
            }
        }
    }
