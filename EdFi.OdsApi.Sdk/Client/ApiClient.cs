...
namespace EdFi.OdsApi.Sdk.Client
{
    ...
    internal class CustomJsonCodec : RestSharp.Serializers.ISerializer, RestSharp.Deserializers.IDeserializer
    {
        ...
        {
            if (obj is not null and EdFi.OdsApi.Sdk.Models.All.AbstractOpenAPISchema)
            {
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        /// </summary>
        public ApiClient(Configuration authenticatedConfiguration)
        {
        ...
        private RestSharpMethod Method(HttpMethod method)
        {
            var other = method switch
            {
                ...
                _ => throw new ArgumentOutOfRangeException("method", method, null),
            };
            return other;
        }
            ...
            IReadableConfiguration configuration)
        {
            ...
            if (options.Cookies != null && options.Cookies.Count > 0)
            {
                ...
                {
                    _ = request.AddCookie(cookie.Name, cookie.Value);
                }
            }
