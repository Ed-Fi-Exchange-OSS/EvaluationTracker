...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmCandidateOtherName : IEquatable<TpdmCandidateOtherName>, IValidatableObject
    {
        ...
        public TpdmCandidateOtherName(string otherNameTypeDescriptor = default, string firstName = default, string generationCodeSuffix = default, string lastSurname = default, string middleName = default, string personalTitlePrefix = default)
        {
            OtherNameTypeDescriptor = otherNameTypeDescriptor ?? throw new ArgumentNullException("otherNameTypeDescriptor is a required property for TpdmCandidateOtherName and cannot be null");
            FirstName = firstName ?? throw new ArgumentNullException("firstName is a required property for TpdmCandidateOtherName and cannot be null");
            LastSurname = lastSurname ?? throw new ArgumentNullException("lastSurname is a required property for TpdmCandidateOtherName and cannot be null");
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmCandidateOtherName {\n");
        ...
        {
            return Equals(input as TpdmCandidateOtherName);
        }
