...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationTypeDescriptor : IEquatable<TpdmEvaluationTypeDescriptor>, IValidatableObject
    {
        ...
        public TpdmEvaluationTypeDescriptor(string id = default, int evaluationTypeDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationTypeDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationTypeDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationTypeDescriptor and cannot be null");
            Id = id;
            EvaluationTypeDescriptorId = evaluationTypeDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationTypeDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  EvaluationTypeDescriptorId: ").Append(EvaluationTypeDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmEvaluationTypeDescriptor);
        }
...
&& (
                ...
                (
                    EvaluationTypeDescriptorId == input.EvaluationTypeDescriptorId ||
                    EvaluationTypeDescriptorId.Equals(input.EvaluationTypeDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + EvaluationTypeDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
