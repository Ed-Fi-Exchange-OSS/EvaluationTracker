...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmCredentialStatusDescriptor : IEquatable<TpdmCredentialStatusDescriptor>, IValidatableObject
    {
        ...
        public TpdmCredentialStatusDescriptor(string id = default, int credentialStatusDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmCredentialStatusDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmCredentialStatusDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmCredentialStatusDescriptor and cannot be null");
            Id = id;
            CredentialStatusDescriptorId = credentialStatusDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmCredentialStatusDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  CredentialStatusDescriptorId: ").Append(CredentialStatusDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmCredentialStatusDescriptor);
        }
...
&& (
                ...
                (
                    CredentialStatusDescriptorId == input.CredentialStatusDescriptorId ||
                    CredentialStatusDescriptorId.Equals(input.CredentialStatusDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + CredentialStatusDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
