...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationRatingStatusDescriptor : IEquatable<TpdmEvaluationRatingStatusDescriptor>, IValidatableObject
    {
        ...
        public TpdmEvaluationRatingStatusDescriptor(string id = default, int evaluationRatingStatusDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationRatingStatusDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationRatingStatusDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationRatingStatusDescriptor and cannot be null");
            Id = id;
            EvaluationRatingStatusDescriptorId = evaluationRatingStatusDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationRatingStatusDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  EvaluationRatingStatusDescriptorId: ").Append(EvaluationRatingStatusDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmEvaluationRatingStatusDescriptor);
        }
...
&& (
                ...
                (
                    EvaluationRatingStatusDescriptorId == input.EvaluationRatingStatusDescriptorId ||
                    EvaluationRatingStatusDescriptorId.Equals(input.EvaluationRatingStatusDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + EvaluationRatingStatusDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
