...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEnglishLanguageExamDescriptor : IEquatable<TpdmEnglishLanguageExamDescriptor>, IValidatableObject
    {
        ...
        public TpdmEnglishLanguageExamDescriptor(string id = default, int englishLanguageExamDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmEnglishLanguageExamDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmEnglishLanguageExamDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmEnglishLanguageExamDescriptor and cannot be null");
            Id = id;
            EnglishLanguageExamDescriptorId = englishLanguageExamDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEnglishLanguageExamDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  EnglishLanguageExamDescriptorId: ").Append(EnglishLanguageExamDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmEnglishLanguageExamDescriptor);
        }
...
&& (
                ...
                (
                    EnglishLanguageExamDescriptorId == input.EnglishLanguageExamDescriptorId ||
                    EnglishLanguageExamDescriptorId.Equals(input.EnglishLanguageExamDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + EnglishLanguageExamDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
