...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationPeriodDescriptor : IEquatable<TpdmEvaluationPeriodDescriptor>, IValidatableObject
    {
        ...
        public TpdmEvaluationPeriodDescriptor(string id = default, int evaluationPeriodDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationPeriodDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationPeriodDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationPeriodDescriptor and cannot be null");
            Id = id;
            EvaluationPeriodDescriptorId = evaluationPeriodDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationPeriodDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  EvaluationPeriodDescriptorId: ").Append(EvaluationPeriodDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmEvaluationPeriodDescriptor);
        }
...
&& (
                ...
                (
                    EvaluationPeriodDescriptorId == input.EvaluationPeriodDescriptorId ||
                    EvaluationPeriodDescriptorId.Equals(input.EvaluationPeriodDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + EvaluationPeriodDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
