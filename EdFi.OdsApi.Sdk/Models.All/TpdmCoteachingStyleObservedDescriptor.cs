...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmCoteachingStyleObservedDescriptor : IEquatable<TpdmCoteachingStyleObservedDescriptor>, IValidatableObject
    {
        ...
        public TpdmCoteachingStyleObservedDescriptor(string id = default, int coteachingStyleObservedDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmCoteachingStyleObservedDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmCoteachingStyleObservedDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmCoteachingStyleObservedDescriptor and cannot be null");
            Id = id;
            CoteachingStyleObservedDescriptorId = coteachingStyleObservedDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmCoteachingStyleObservedDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  CoteachingStyleObservedDescriptorId: ").Append(CoteachingStyleObservedDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmCoteachingStyleObservedDescriptor);
        }
...
&& (
                ...
                (
                    CoteachingStyleObservedDescriptorId == input.CoteachingStyleObservedDescriptorId ||
                    CoteachingStyleObservedDescriptorId.Equals(input.CoteachingStyleObservedDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + CoteachingStyleObservedDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
