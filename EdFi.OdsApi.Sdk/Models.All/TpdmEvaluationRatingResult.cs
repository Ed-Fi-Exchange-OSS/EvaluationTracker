...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationRatingResult : IEquatable<TpdmEvaluationRatingResult>, IValidatableObject
    {
        ...
        public TpdmEvaluationRatingResult(double rating = default, string ratingResultTitle = default, string resultDatatypeTypeDescriptor = default)
        {
            Rating = rating;
            RatingResultTitle = ratingResultTitle ?? throw new ArgumentNullException("ratingResultTitle is a required property for TpdmEvaluationRatingResult and cannot be null");
            ResultDatatypeTypeDescriptor = resultDatatypeTypeDescriptor ?? throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for TpdmEvaluationRatingResult and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationRatingResult {\n");
        ...
        {
            return Equals(input as TpdmEvaluationRatingResult);
        }
