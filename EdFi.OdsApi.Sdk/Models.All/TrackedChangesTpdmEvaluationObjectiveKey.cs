...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesTpdmEvaluationObjectiveKey : IEquatable<TrackedChangesTpdmEvaluationObjectiveKey>, IValidatableObject
    {
        ...
        public TrackedChangesTpdmEvaluationObjectiveKey(string evaluationObjectiveTitle = default(string), int educationOrganizationId = default(int), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string))
        {
