...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmObjectiveRatingLevelDescriptor : IEquatable<TpdmObjectiveRatingLevelDescriptor>, IValidatableObject
    {
        ...
        public TpdmObjectiveRatingLevelDescriptor(string id = default, int objectiveRatingLevelDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmObjectiveRatingLevelDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmObjectiveRatingLevelDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmObjectiveRatingLevelDescriptor and cannot be null");
            Id = id;
            ObjectiveRatingLevelDescriptorId = objectiveRatingLevelDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmObjectiveRatingLevelDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  ObjectiveRatingLevelDescriptorId: ").Append(ObjectiveRatingLevelDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmObjectiveRatingLevelDescriptor);
        }
...
&& (
                ...
                (
                    ObjectiveRatingLevelDescriptorId == input.ObjectiveRatingLevelDescriptorId ||
                    ObjectiveRatingLevelDescriptorId.Equals(input.ObjectiveRatingLevelDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + ObjectiveRatingLevelDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
