...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmRubricRatingLevelDescriptor : IEquatable<TpdmRubricRatingLevelDescriptor>, IValidatableObject
    {
        ...
        public TpdmRubricRatingLevelDescriptor(string id = default, int rubricRatingLevelDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmRubricRatingLevelDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmRubricRatingLevelDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmRubricRatingLevelDescriptor and cannot be null");
            Id = id;
            RubricRatingLevelDescriptorId = rubricRatingLevelDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmRubricRatingLevelDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  RubricRatingLevelDescriptorId: ").Append(RubricRatingLevelDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmRubricRatingLevelDescriptor);
        }
...
&& (
                ...
                (
                    RubricRatingLevelDescriptorId == input.RubricRatingLevelDescriptorId ||
                    RubricRatingLevelDescriptorId.Equals(input.RubricRatingLevelDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + RubricRatingLevelDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
