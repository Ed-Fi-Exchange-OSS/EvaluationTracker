...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesTpdmPerformanceEvaluationRatingKey : IEquatable<TrackedChangesTpdmPerformanceEvaluationRatingKey>, IValidatableObject
    {
        ...
        public TrackedChangesTpdmPerformanceEvaluationRatingKey(int educationOrganizationId = default(int), string evaluationPeriodDescriptor = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string), string personId = default(string), string sourceSystemDescriptor = default(string))
        {
