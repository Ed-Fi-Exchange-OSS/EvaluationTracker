...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesTpdmPerformanceEvaluationKey : IEquatable<TrackedChangesTpdmPerformanceEvaluationKey>, IValidatableObject
    {
        ...
        public TrackedChangesTpdmPerformanceEvaluationKey(string evaluationPeriodDescriptor = default(string), string performanceEvaluationTypeDescriptor = default(string), string termDescriptor = default(string), string performanceEvaluationTitle = default(string), int educationOrganizationId = default(int), int schoolYear = default(int))
        {
