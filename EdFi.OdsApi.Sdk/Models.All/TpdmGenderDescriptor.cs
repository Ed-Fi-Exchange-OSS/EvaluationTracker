...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmGenderDescriptor : IEquatable<TpdmGenderDescriptor>, IValidatableObject
    {
        ...
        public TpdmGenderDescriptor(string id = default, int genderDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmGenderDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmGenderDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmGenderDescriptor and cannot be null");
            Id = id;
            GenderDescriptorId = genderDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmGenderDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  GenderDescriptorId: ").Append(GenderDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmGenderDescriptor);
        }
...
&& (
                ...
                (
                    GenderDescriptorId == input.GenderDescriptorId ||
                    GenderDescriptorId.Equals(input.GenderDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + GenderDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
