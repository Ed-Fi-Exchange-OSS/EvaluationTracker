...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesTpdmEvaluationElementKey : IEquatable<TrackedChangesTpdmEvaluationElementKey>, IValidatableObject
    {
        ...
        public TrackedChangesTpdmEvaluationElementKey(string evaluationElementTitle = default(string), int educationOrganizationId = default(int), string evaluationObjectiveTitle = default(string), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string))
        {
