...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmPerformanceEvaluationTypeDescriptor : IEquatable<TpdmPerformanceEvaluationTypeDescriptor>, IValidatableObject
    {
        ...
        public TpdmPerformanceEvaluationTypeDescriptor(string id = default, int performanceEvaluationTypeDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmPerformanceEvaluationTypeDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmPerformanceEvaluationTypeDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmPerformanceEvaluationTypeDescriptor and cannot be null");
            Id = id;
            PerformanceEvaluationTypeDescriptorId = performanceEvaluationTypeDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmPerformanceEvaluationTypeDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  PerformanceEvaluationTypeDescriptorId: ").Append(PerformanceEvaluationTypeDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmPerformanceEvaluationTypeDescriptor);
        }
...
&& (
                ...
                (
                    PerformanceEvaluationTypeDescriptorId == input.PerformanceEvaluationTypeDescriptorId ||
                    PerformanceEvaluationTypeDescriptorId.Equals(input.PerformanceEvaluationTypeDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + PerformanceEvaluationTypeDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
