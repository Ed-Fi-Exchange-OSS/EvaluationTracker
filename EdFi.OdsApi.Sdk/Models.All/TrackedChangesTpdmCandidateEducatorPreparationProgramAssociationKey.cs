...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesTpdmCandidateEducatorPreparationProgramAssociationKey : IEquatable<TrackedChangesTpdmCandidateEducatorPreparationProgramAssociationKey>, IValidatableObject
    {
        ...
        public TrackedChangesTpdmCandidateEducatorPreparationProgramAssociationKey(DateTime beginDate = default(DateTime), string candidateIdentifier = default(string), int educationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string))
        {
