...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationRatingLevelDescriptor : IEquatable<TpdmEvaluationRatingLevelDescriptor>, IValidatableObject
    {
        ...
        public TpdmEvaluationRatingLevelDescriptor(string id = default, int evaluationRatingLevelDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationRatingLevelDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationRatingLevelDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationRatingLevelDescriptor and cannot be null");
            Id = id;
            EvaluationRatingLevelDescriptorId = evaluationRatingLevelDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationRatingLevelDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  EvaluationRatingLevelDescriptorId: ").Append(EvaluationRatingLevelDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmEvaluationRatingLevelDescriptor);
        }
...
&& (
                ...
                (
                    EvaluationRatingLevelDescriptorId == input.EvaluationRatingLevelDescriptorId ||
                    EvaluationRatingLevelDescriptorId.Equals(input.EvaluationRatingLevelDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + EvaluationRatingLevelDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
