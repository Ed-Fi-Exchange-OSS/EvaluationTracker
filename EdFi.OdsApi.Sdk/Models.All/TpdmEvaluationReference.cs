...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationReference : IEquatable<TpdmEvaluationReference>, IValidatableObject
    {
        ...
        public TpdmEvaluationReference(int educationOrganizationId = default, string evaluationPeriodDescriptor = default, string evaluationTitle = default, string performanceEvaluationTitle = default, string performanceEvaluationTypeDescriptor = default, int schoolYear = default, string termDescriptor = default, Link link = default)
        {
            EducationOrganizationId = educationOrganizationId;
            EvaluationPeriodDescriptor = evaluationPeriodDescriptor ?? throw new ArgumentNullException("evaluationPeriodDescriptor is a required property for TpdmEvaluationReference and cannot be null");
            EvaluationTitle = evaluationTitle ?? throw new ArgumentNullException("evaluationTitle is a required property for TpdmEvaluationReference and cannot be null");
            PerformanceEvaluationTitle = performanceEvaluationTitle ?? throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmEvaluationReference and cannot be null");
            PerformanceEvaluationTypeDescriptor = performanceEvaluationTypeDescriptor ?? throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmEvaluationReference and cannot be null");
            SchoolYear = schoolYear;
            TermDescriptor = termDescriptor ?? throw new ArgumentNullException("termDescriptor is a required property for TpdmEvaluationReference and cannot be null");
            Link = link;
        }
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationReference {\n");
        ...
        {
            return Equals(input as TpdmEvaluationReference);
        }
