...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationElementRatingLevelDescriptor : IEquatable<TpdmEvaluationElementRatingLevelDescriptor>, IValidatableObject
    {
        ...
        public TpdmEvaluationElementRatingLevelDescriptor(string id = default, int evaluationElementRatingLevelDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationElementRatingLevelDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationElementRatingLevelDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationElementRatingLevelDescriptor and cannot be null");
            Id = id;
            EvaluationElementRatingLevelDescriptorId = evaluationElementRatingLevelDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationElementRatingLevelDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  EvaluationElementRatingLevelDescriptorId: ").Append(EvaluationElementRatingLevelDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmEvaluationElementRatingLevelDescriptor);
        }
...
&& (
                ...
                (
                    EvaluationElementRatingLevelDescriptorId == input.EvaluationElementRatingLevelDescriptorId ||
                    EvaluationElementRatingLevelDescriptorId.Equals(input.EvaluationElementRatingLevelDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + EvaluationElementRatingLevelDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
