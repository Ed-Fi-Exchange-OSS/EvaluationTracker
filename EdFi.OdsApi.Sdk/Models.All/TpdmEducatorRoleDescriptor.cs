...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEducatorRoleDescriptor : IEquatable<TpdmEducatorRoleDescriptor>, IValidatableObject
    {
        ...
        public TpdmEducatorRoleDescriptor(string id = default, int educatorRoleDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmEducatorRoleDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmEducatorRoleDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmEducatorRoleDescriptor and cannot be null");
            Id = id;
            EducatorRoleDescriptorId = educatorRoleDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEducatorRoleDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  EducatorRoleDescriptorId: ").Append(EducatorRoleDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmEducatorRoleDescriptor);
        }
...
&& (
                ...
                (
                    EducatorRoleDescriptorId == input.EducatorRoleDescriptorId ||
                    EducatorRoleDescriptorId.Equals(input.EducatorRoleDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + EducatorRoleDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
