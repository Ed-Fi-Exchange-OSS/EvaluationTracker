...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesTpdmEducatorPreparationProgramKey : IEquatable<TrackedChangesTpdmEducatorPreparationProgramKey>, IValidatableObject
    {
        ...
        public TrackedChangesTpdmEducatorPreparationProgramKey(string programTypeDescriptor = default(string), string programName = default(string), int educationOrganizationId = default(int))
        {
