...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmCertificationRouteDescriptor : IEquatable<TpdmCertificationRouteDescriptor>, IValidatableObject
    {
        ...
        public TpdmCertificationRouteDescriptor(string id = default, int certificationRouteDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmCertificationRouteDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmCertificationRouteDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmCertificationRouteDescriptor and cannot be null");
            Id = id;
            CertificationRouteDescriptorId = certificationRouteDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmCertificationRouteDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  CertificationRouteDescriptorId: ").Append(CertificationRouteDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmCertificationRouteDescriptor);
        }
...
&& (
                ...
                (
                    CertificationRouteDescriptorId == input.CertificationRouteDescriptorId ||
                    CertificationRouteDescriptorId.Equals(input.CertificationRouteDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + CertificationRouteDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
