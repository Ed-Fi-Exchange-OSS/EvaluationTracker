...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationObjectiveRatingReference : IEquatable<TpdmEvaluationObjectiveRatingReference>, IValidatableObject
    {
        ...
        public TpdmEvaluationObjectiveRatingReference(int educationOrganizationId = default, DateTime evaluationDate = default, string evaluationObjectiveTitle = default, string evaluationPeriodDescriptor = default, string evaluationTitle = default, string performanceEvaluationTitle = default, string performanceEvaluationTypeDescriptor = default, string personId = default, int schoolYear = default, string sourceSystemDescriptor = default, string termDescriptor = default, Link link = default)
        {
            EducationOrganizationId = educationOrganizationId;
            EvaluationDate = evaluationDate;
            EvaluationObjectiveTitle = evaluationObjectiveTitle ?? throw new ArgumentNullException("evaluationObjectiveTitle is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            EvaluationPeriodDescriptor = evaluationPeriodDescriptor ?? throw new ArgumentNullException("evaluationPeriodDescriptor is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            EvaluationTitle = evaluationTitle ?? throw new ArgumentNullException("evaluationTitle is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            PerformanceEvaluationTitle = performanceEvaluationTitle ?? throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            PerformanceEvaluationTypeDescriptor = performanceEvaluationTypeDescriptor ?? throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            PersonId = personId ?? throw new ArgumentNullException("personId is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            SchoolYear = schoolYear;
            SourceSystemDescriptor = sourceSystemDescriptor ?? throw new ArgumentNullException("sourceSystemDescriptor is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            TermDescriptor = termDescriptor ?? throw new ArgumentNullException("termDescriptor is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            Link = link;
        }
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationObjectiveRatingReference {\n");
        ...
        {
            return Equals(input as TpdmEvaluationObjectiveRatingReference);
        }
