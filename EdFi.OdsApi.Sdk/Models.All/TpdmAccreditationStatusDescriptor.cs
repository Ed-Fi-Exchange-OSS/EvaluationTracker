...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmAccreditationStatusDescriptor : IEquatable<TpdmAccreditationStatusDescriptor>, IValidatableObject
    {
        ...
        public TpdmAccreditationStatusDescriptor(string id = default, int accreditationStatusDescriptorId = default, string codeValue = default, string description = default, DateTime? effectiveBeginDate = default, DateTime? effectiveEndDate = default, string _namespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
            CodeValue = codeValue ?? throw new ArgumentNullException("codeValue is a required property for TpdmAccreditationStatusDescriptor and cannot be null");
            Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for TpdmAccreditationStatusDescriptor and cannot be null");
            ShortDescription = shortDescription ?? throw new ArgumentNullException("shortDescription is a required property for TpdmAccreditationStatusDescriptor and cannot be null");
            Id = id;
            AccreditationStatusDescriptorId = accreditationStatusDescriptorId;
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmAccreditationStatusDescriptor {\n");
            _ = sb.Append("  Id: ").Append(Id).Append("\n");
            _ = sb.Append("  AccreditationStatusDescriptorId: ").Append(AccreditationStatusDescriptorId).Append("\n");
        ...
        {
            return Equals(input as TpdmAccreditationStatusDescriptor);
        }
...
&& (
                ...
                (
                    AccreditationStatusDescriptorId == input.AccreditationStatusDescriptorId ||
                    AccreditationStatusDescriptorId.Equals(input.AccreditationStatusDescriptorId)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + AccreditationStatusDescriptorId.GetHashCode();
                if (CodeValue != null)
                {
