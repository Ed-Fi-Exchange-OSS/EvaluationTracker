...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationElementRatingLevel : IEquatable<TpdmEvaluationElementRatingLevel>, IValidatableObject
    {
        ...
        public TpdmEvaluationElementRatingLevel(string evaluationRatingLevelDescriptor = default, double? maxRating = default, double? minRating = default)
        {
            EvaluationRatingLevelDescriptor = evaluationRatingLevelDescriptor ?? throw new ArgumentNullException("evaluationRatingLevelDescriptor is a required property for TpdmEvaluationElementRatingLevel and cannot be null");
            MaxRating = maxRating;
            MinRating = minRating;
        }
        ...
        public override string ToString()
        {
            ...
            _ = sb.Append("class TpdmEvaluationElementRatingLevel {\n");
        ...
        {
            return Equals(input as TpdmEvaluationElementRatingLevel);
        }
